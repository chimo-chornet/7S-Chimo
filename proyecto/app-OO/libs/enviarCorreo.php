...
function enviaCorreo($mailUsuario,$sujeto,$nombre,$mensaje)
{
    ...
    try {
        ...
        */
        $mail->Username   = 'chimochomet@gmail.com';
        $mail->Password   = 'afwz vmtp gtgs wefs';
        /*
        ...
        */
        //Remitente
        $mail->setFrom('chimochomet@gmail.com', 'App Intercambio de Servicios');
        //Receptores. Podemos añadir más de uno. El segundo argumento es opcional, es el nombre
        $mail->addAddress($mailUsuario, $nombre);     //Add a recipient
        ...
        return "El mensaje no se ha enviado: {$mail->ErrorInfo}";
